...
class LocalizationNet(tf.keras.Model):
    def __init__(self, F):
        ...
        self.Conv_1 = tf.keras.layers.Conv2D(64, (3, 3), padding="same")
        self.Conv_2 = tf.keras.layers.Conv2D(128, (3, 3), padding="same")
        self.Conv_3 = tf.keras.layers.Conv2D(256, (3, 3), padding="same")
        self.Conv_4 = tf.keras.layers.Conv2D(512, (3, 3), padding="same")
